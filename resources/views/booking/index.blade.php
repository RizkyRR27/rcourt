    ...
    <div class="bg-[var(--color-court-paper)] pb-20 pt-10">
        ...
        <div class="mt-8 max-w-4xl mx-auto">
            <div class="border-2 border-black bg-yellow-50 p-6 shadow-hard relative">
                <div
                    class="absolute -top-3 -left-3 bg-red-600 text-white font-mono font-bold px-4 py-1 transform -rotate-2 border-2 border-black shadow-sm">
                    INFO PENTING
                </div>
        ...
        <div class="mx-auto max-w-4xl px-4 mb-8">
            @if (session('error'))
                <div
                    class="border-2 border-red-600 bg-red-100 p-4 shadow-hard text-red-800 flex items-start gap-4 mb-4">
